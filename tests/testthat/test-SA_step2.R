...
phantom_assignment <-list("CovM1M2"=seq(0,.4,.1),
                       "CovM1X"= 0,
                       "CovM1Y2"= seq(-.3,.3,.1),
                       "CovY1M1"= "CovY2M2",
                       "CovY1M2"= "CovM1Y2",
...
test_that("Check that phantom variables equal to other phantom variables will error out if the phantom variable name is not written correctly", {
  ...
  phantom_assignment2 <-list("CovM1M2"=seq(0,.4,.1),
                             "CovM1X"= 0,
                             "CovM1Y2"= seq(0,.3,.1),
                             "CovY1M1"= "CovM2Y2",
                             "CovY1M2"= "CovY2M1",
...
test_that("Check if covariance names can be written with the variables in either order (e.g., CovY1Y2 and CovY2Y1)", {
  ...
  phantom_assignment1 <-list("CovM1M2"=seq(0,.4,.1),
                             "CovM1X"= "CovXM2",
                             "CovM1Y2"= "CovM2Y2",
                             "CovY1M1"= "CovY2M2",
                             "CovY1M2"= "CovM2Y2",
...
phantom_assignment <-list("CovM1M2"="CovM2Y2",
                          "CovM1X"= "CovM2X",
                          "CovM1Y2"= "CovM2Y2",
                          "CovY1M1"= "CovM2Y2",
                          "CovY1M2"= "CovM2Y2",
